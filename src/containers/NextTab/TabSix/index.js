...
import {setSaveImgSixAction} from '../../../store/action';
    ...
    return (
      <ImageBackground
        ...
        <View style={styless.viewOne}>
          ...
          <Text style={styless.textOne}>Extra - Oral Views 6:8</Text>
          ...
          <ButtonTab
            title="Next"
            onPress={() => this.props.navigation.navigate('TabSeven')}
          />
        </View>
      </ImageBackground>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(TabSix);
